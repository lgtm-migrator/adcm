...
class TestServiceAPI(BaseTestCase):
    ...
    def test_change_maintenance_mode_on_with_action_success(self):
        action = Action.objects.create(prototype=self.service.prototype, name="adcm_turn_on_maintenance_mode")
    ...
    def test_change_maintenance_mode_off_with_action_success(self):
        self.service.maintenance_mode = MaintenanceMode.ON
        self.service.save()
        action = Action.objects.create(prototype=self.service.prototype, name="adcm_turn_off_maintenance_mode")
