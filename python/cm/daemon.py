...
class Daemon:
    ...
    def daemonize(self):
        ...
        try:
            pidfile = open(self.pidfile, "w+", encoding=ENCODING)
        except IOError as e:
        ...
        sys.stdout.flush()
        sys.stderr.flush()
        si = open(self.stdin, "r", encoding=ENCODING)
        so = open(self.stdout, "a+", encoding=ENCODING)
        se = open(self.stderr, "w+", encoding=ENCODING)
    ...
    def getpid(self):
        ...
        try:
            pf = open(self.pidfile, "r", encoding=ENCODING)
            try:
