...
def _test_two_filters(client: ADCMClient, page: LoginAuditPage):
    with allure.step("Add two filters and check records"):
        ...
        _check_records(
            ...
            page=page,
            filters=(
                lambda rec: rec.login_details and rec.login_details.get("username") == "admin",
    ...
    with allure.step("Refresh one filter and only one filter is not applied"):
        ...
        _check_records(
            client=client,
            page=page,
            filters=(lambda rec: rec.login_details and rec.login_details.get("username") == "admin",),
        )
