...
class CommonHeaderLocators:
    ...
    hostproviders = Locator(
        By.CSS_SELECTOR, ".topmenu_hostproviders", "Header button Hostproviders"
    )
...
class AuthorizedHeaderLocators(CommonHeaderLocators):
    ...
    account_button = Locator(
        By.CSS_SELECTOR, "button[adcm_test='account']", "Header button for account settings"
    )
    ...
    class JobPopup:
        ...
        success_jobs = Locator(
            By.CSS_SELECTOR, "div[mattooltip='Show success jobs']", "Success jobs"
        )
        in_progress_jobs = Locator(
            By.CSS_SELECTOR, "div[mattooltip='Show jobs in progress']", "In progress jobs"
        )
        failed_jobs = Locator(By.CSS_SELECTOR, "div[mattooltip='Show failed jobs']", "Failed jobs")
        job_row = Locator(
            By.CSS_SELECTOR, "div>div[class*='notification']", "Job row in popup list"
        )
