...
class CommonPopupLocators:
    ...
    block_by_text = TemplateLocator(
        By.XPATH, "//app-snack-bar//div[text()='{}']", "Popup block with text {}"
    )
    ...
    verbose_chbx = Locator(
        By.XPATH, "//mat-checkbox[.//span[text()='Verbose']]", "Verbose checkbox"
    )
...
class HostCreationLocators:
    ...
    fqdn_input = Locator(
        By.CSS_SELECTOR, "input[data-placeholder='Fully qualified domain name']", "Host FQDN input"
    )
    create_btn = Locator(
        By.XPATH, "//app-add-controls//button[./span[contains(text(), 'Create')]]", "Create button"
    )
    cancel_btn = Locator(
        By.XPATH, "//app-add-controls//button[./span[text()='Cancel']]", "Cancel button"
    )
    ...
    class Provider:
        ...
        chosen_provider = Locator(
            By.CSS_SELECTOR, "mat-select[placeholder*='Hostprovider']", "Chosen provider field"
        )
        add_btn = Locator(
            By.XPATH, "//mat-form-field//mat-icon[text()='add']", "Add host provider button"
        )
        new_provider_block = Locator(
            By.CSS_SELECTOR, "app-add-provider", "Host provider creation block"
        )
        new_provider_name = Locator(
            By.CSS_SELECTOR, "input[formcontrolname='name']", "New host provider name"
        )
    ...
    class Cluster:
        ...
        cluster_select = Locator(
            By.CSS_SELECTOR, "mat-select[formcontrolname='cluster_id']", "Cluster choice select"
        )
